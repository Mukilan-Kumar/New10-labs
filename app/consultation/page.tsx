...
export default function ConsultationPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (result.success) {
                // Data saved successfully, now redirect to WhatsApp
                ...
                message += `*Consultation ID:* ${result.data.consultationId}\n\n`;
                ...
                // If API fails, still allow WhatsApp booking
                alert('Could not save to database, but you can still book via WhatsApp');
            ...
            alert('An error occurred. Redirecting to WhatsApp...');
            
            // Still allow WhatsApp booking even if there's an error
            let message = `Hi, I would like to book an Online Consultation from New10Lab.\n\n`;
            message += `*My Details:*\n`;
            message += `*Name:* ${formData.name}\n`;
            message += `*Email:* ${formData.email}\n`;
