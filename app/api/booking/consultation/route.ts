...
const ADMIN_EMAIL = process.env.ADMIN_EMAIL || 'mukilan021@gmail.com';
    ...
    <body>
      <div class="container">
        ...
        <div class="content">
          ...
          <p>If you have any urgent concerns, please call us at <strong>+91 9360264347</strong></p>
  ...
  try {
    ...
    if (!name || !phone || !email || !message) {
      return NextResponse.json(
        { success: false, message: 'All fields are required (name, phone, email, message)' },
        { status: 400 }
      );
    }
    ...
    if (dbError) {
      ...
      return NextResponse.json(
        { success: false, message: 'Failed to save consultation to database' },
        { status: 500 }
      );
    }

    console.log('=================================');
    console.log('📋 NEW CONSULTATION REQUEST (GET)');
    console.log('=================================');
    ...
    console.log('Database ID:', consultation.id);
    console.log('=================================\n');
    ...
    return NextResponse.json({
      ...
      data: {
        ...
        message,
        status: 'pending',
        bookedAt: consultation.created_at,
      },
    });
  } catch (error) {
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log('=================================');
    console.log('📋 NEW CONSULTATION REQUEST (POST)');
    console.log('=================================');
    console.log('Consultation ID:', consultationId);
    console.log('Patient Name:', name);
    console.log('Email:', email);
